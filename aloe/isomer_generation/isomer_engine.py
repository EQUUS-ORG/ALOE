...
class rd_enumerate_isomer(object):
    """
    Enumerate stereoisomers starting from an CSV file.
    ...
    def __init__(
        ...
        enumerated_csv (str): the path to the output csv file
        enumerate_tauts (bool): whether to enumerate tautomers
        onlyUnassigned (bool): whether to enumerate only unassigned stereocenters
        unique (bool): whether to enumerate only unique stereoisomers
        """
        self.csv = csv
