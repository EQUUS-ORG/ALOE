...
from aloe.bdfe_calculation.product_generator import generate_products, diamine_hook, diimine_goes_EZ_hook
...
def get_BDFE(reduced_form_file: str, 
    ...
    if use_reduced_names:
        ...
        reduced_form_df["base_name"] = reduced_form_df["Name_reduced"].apply(lambda x: x.split("_")[0])
